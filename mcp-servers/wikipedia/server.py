...
@mcp.resource("/summary/{title}/query/{query}/length/{max_length}")
...
@mcp.resource("/summary/{title}/section/{section_title}/length/{max_length}")
...
@mcp.resource("/facts/{title}/topic/{topic_within_article}/count/{count}")
...
@mcp.resource("/coordinates/{title}")
